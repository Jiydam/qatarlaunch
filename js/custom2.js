    ...
    if ($('.nekoDataOwl, .neko-data-owl').length) {
        ...
        $('.nekoDataOwl, .neko-data-owl').each(function(index) {
            ...
            $this.owlCarousel({
                ...
                navigationText: ['<i class="icon icon-chevron-right "></i>', '<i class="icon icon-chevron-left"></i>'],
            ...
            slides: [ // Slideshow Images
                {
                    ...
                    title: '<h1>We are a creative agency</h1><a href="#team" class="btn btn-primary">learn more</a>',
                    thumb: '',
                    url: ''
                },
